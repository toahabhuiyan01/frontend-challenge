...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/0PB7sSVlvl)
...
```sh
npx nx serve theysaidfrontend
```

To create a production bundle:

```sh
npx nx build theysaidfrontend
```

To see all available targets to run for a project, run:

```sh
npx nx show project theysaidfrontend
```
